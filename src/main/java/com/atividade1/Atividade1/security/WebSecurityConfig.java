...
import com.atividade1.Atividade1.security.service.UserDetailsServiceImpl;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/auth/**", "/roles", "/instrutores/dto", "/turmas/dto", "/swagger-ui/**", "/v3/api-docs/**").permitAll() //define as rotas publicas/abertas
